    ...
    while capture.isOpened():
        ...
        if hands_list:                                    
            ...
            #for each each set of landmark lists corresponding to each detected hand...
                ...
                #any of the dimentional components (x,y or z) can be accessed using lm_list[num].dimensional_comp
                #Ex: lm_list[0].x returns the x compnent of the first landmark, which happens to be the wrist. 
